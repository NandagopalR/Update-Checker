...
package com.orgware.updatechecker.utils;
...
import com.orgware.updatechecker.R;
...
//        }]
    ...
    private boolean web_update() {
        try {
            String new_version = Jsoup.connect("https://play.google.com/store/apps/details?id=com.orgware.top4drivers&hl=en")
                    .timeout(30000)
                    ...
                    .first()
                    .ownText();
            Log.e("Versions", "New - " + new_version + " - Old - " + current_version);
    ...
    private void show_dialog_you_are_not_updated() {
        ...
        alertDialogBuilder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.orgware.top4drivers")));
                dialog.cancel();
                OrientationUtils.unlockOrientation(activity);
            }
        });
